...
#define SSID "Bharadwaj" 
#define PASS "18261A0223" 
#define IP "184.106.153.149" // thingspeak.com IP
#define DHT22_PIN 2
String GET = "GET /update?key= WS96FCCUUM5RD2U8&field1=";
SoftwareSerial monitor(10, 11); //Serial communication to ESP8266 
module (RX, TX)
dht DHT;
...
void setup()
{
 ...
 if(!bmp.begin())
 {
 Serial.println("BMP085 sensor wasn't detected. Verify your 
connections or I2C ADDR!");
 while(1);
 }
...
void loop(){
 ...
 {
 ratio = lowpulseoccupancy/(sampletime_ms*10.0); // percentage 
(de 0 a 100%)
 concentration = 1.1*pow(ratio,3)-
3.8*pow(ratio,2)+520*ratio+0.62; // from datsheet
 lowpulseoccupancy = 0;
 ...
 updateSensors(luminanceStr, humidityStr, temperatureStr, uvStr, 
dustStr, pressureStr, temperature1Str);
...
//Send data to ThingSpeak
void updateSensors(String luminanceStr, String humidityStr, String
temperatureStr, String uvStr, String dustStr, String pressureStr, 
